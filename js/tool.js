var createTool = function() {
	...
	function createDamageCalc() {
		...
		var toolSectionContentDMGAll = document.createElement("div");
		...
		var toolSectionContentDMGResultBox = document.createElement("span");
		...
		toolSectionContentDMGAll.setAttribute("name","field");
		...
		toolSectionContentDMGContent.appendChild(toolSectionContentDMGAll);
		...
		toolSectionContentDMGResult.appendChild(toolSectionContentDMGResultBox);
...
function DMGCalcStart() {
	...
	var alldivbase = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > div > span[name] > div[name]");

	// User
	var user = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > div > span[name] > div.user");
	var userid = user.getAttribute("name");
	var userteam = user.parentElement.getAttribute("name");

	var userbase = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] > div span[name='"+userteam+"'] ul[name='"+userid+"']");
	var userbaseteam = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] > div ol[name='team'] > span[name='"+userteam+"']");
	...
	var userStabPath = user.querySelector(":scope *[name='stab']");
	...
	var userModAccuracyPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='options'] > div:last-child > span[name='"+userteam+"'] > ul[name='"+userid+"'] *[name='stats'] > span > span[name='Mod'] input[name='Accuracy']");
	var userModEvasionPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='options'] > div:last-child > span[name='"+userteam+"'] > ul[name='"+userid+"'] *[name='stats'] > span > span[name='Mod'] input[name='Evasion']");
	var userModCriticalPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='options'] > div:last-child > span[name='"+userteam+"'] > ul[name='"+userid+"'] *[name='stats'] > span > span[name='Mod'] input[name='Critical']");
	var userModPath = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='options'] > div:last-child > span[name='"+userteam+"'] > ul[name='"+userid+"'] *[name='stats'] > span > span[name='Mod'] input:not(:first-child)");
	var userStatsPath = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='options'] > div:last-child > span[name='"+userteam+"'] > ul[name='"+userid+"'] *[name='stats'] > span > span:last-child input:not(:first-child)");
	var userSpeedStatPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='options'] > div:last-child > span[name='"+userteam+"'] > ul[name='"+userid+"'] *[name='stats'] > span > span:last-child input[name='Speed']");
	...
	var enemies = user.parentElement.parentElement.querySelectorAll(":scope > span:not([name='"+user.parentElement.getAttribute("name")+"']) > div[data-string]");
	...
	var moveRange = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] > div[data-range]").getAttribute("data-range");
	if (moveRange.includes("Affects")) {
		target = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > div > span[name] > div.viable")
	}
	else {
		target = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > div > span[name] > div.target.viable")
	}

	// Weather
	var weatherPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='content'] > div[name='field'] *[name='Weather-Group']");
	var weatherInputsPath = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='content'] > div[name='field'] *[name='Weather-Group'] input");
	var weatherHarshSunlightPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='content'] > div[name='field'] *[name='Weather-Group'] *[name='Harsh Sunlight'] input");
	var weatherRainPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='content'] > div[name='field'] *[name='Weather-Group'] *[name='Rain'] input");
	var weatherSandstormPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='content'] > div[name='field'] *[name='Weather-Group'] *[name='Sandstorm'] input");
	var weatherSnowPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='content'] > div[name='field'] *[name='Weather-Group'] *[name='Snow'] input");
	var weatherFogPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='content'] > div[name='field'] *[name='Weather-Group'] *[name='Fog'] input");
	var weatherHailPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='content'] > div[name='field'] *[name='Weather-Group'] *[name='Hail'] input");
	var weatherExtremelyHarshSunlightPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='content'] > div[name='field'] *[name='Weather-Group'] *[name='Extremely Harsh Sunlight'] input");
	var weatherHeavyRainPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='content'] > div[name='field'] *[name='Weather-Group'] *[name='Heavy Rain'] input");
	var weatherStrongWindsPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='content'] > div[name='field'] *[name='Weather-Group'] *[name='Strong Winds'] input");
	var weatherShadowyAuraPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='content'] > div[name='field'] *[name='Weather-Group'] *[name='Shadowy Aura'] input");

	// Terrain
	var TerrainElectricPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='content'] > div[name='field'] *[name='Terrain-Group'] *[name='Electric Terrain'] input");
	var TerrainGrassyPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='content'] > div[name='field'] *[name='Terrain-Group'] *[name='Grassy Terrain'] input");
	var TerrainMistyPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='content'] > div[name='field'] *[name='Terrain-Group'] *[name='Misty Terrain'] input");
	var TerrainPsychicPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='content'] > div[name='field'] *[name='Terrain-Group'] *[name='Psychic Terrain'] input");


	var gravityPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='content'] > div[name='field'] *[name='Gravity'] input");
	var wonderRoomPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='content'] > div[name='field'] *[name='Wonder Room'] input");
	var magicRoomPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='content'] > div[name='field'] *[name='Magic Room'] input");
	...
	for(var u = 0; u < alldivbase.length; u++) {
		// Defaults
		let effectp = alldivbase[u].querySelector(":scope *[name='effect']");
		let stabp = alldivbase[u].querySelector(":scope *[name='stab']");
		effectp.innerText = "";
		stabp.innerText = "";
	...
	if (check) {
		for (var i = 0; i < alldivbase.length; i++) {
			if (alldivbase[i].getAttribute("data-string") != "" && !alldivbase[i].getAttribute("data-string").includes("pok:|")) {
				...
				var baseModPath = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='options'] > div:last-child > span[name='"+divteam+"'] > ul[name='"+divid+"'] *[name='stats'] > span > span[name='Mod'] input:not(:first-child)");
				var baseStatsPath = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='options'] > div:last-child > span[name='"+divteam+"'] > ul[name='"+divid+"'] *[name='stats'] > span > span:last-child input:not(:first-child)");
				var baseSpeedStatPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='options'] > div:last-child > span[name='"+divteam+"'] > ul[name='"+divid+"'] *[name='stats'] > span > span:last-child input[name='Speed']");
				var baseModEvasionPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='options'] > div:last-child > span[name='"+divteam+"'] > ul[name='"+divid+"'] *[name='stats'] *[name='Mod'] *[name='Evasion']");
				...
				var baseEffectPath = alldivbase[i].querySelector(":scope *[name='effect']");
				...
				if (check) {
					...
					if (Generation == 1) { // DMG Generation 1
						...
						if (baseTypes.length > 0) {
							...
							if (typeadv[2].includes(baseTypes[0].toUpperCase())) {
								used.push(baseTypes[0].toUpperCase())
								Type1 = Type1*2;
							}
					...
					if (effect != "Normal") {
						baseEffectPath.innerText = effect;
					}
...
function DMGCalcPokStats(base) {
	...
	base = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='options'] ol[name='pokémon'] > span[name='"+team+"'] > ul[name='"+id+"']");

	var teambase = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] > div ol[name='team'] > span[name='"+team+"']")
	var base2 = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='options'] > div:last-child > span[name='"+team+"'] > ul[name='"+id+"']")
	...
	var total = base2.querySelector(":scope *[name='stats'] > *:last-child > *:last-child");

	var ivs = base2.querySelectorAll(":scope *[name='stats'] > *:last-child > *:nth-child(2) > input[type='number']:not(:first-child)");
	var evs = base2.querySelectorAll(":scope *[name='stats'] > *:last-child > *:nth-child(3) > input[type='number']:not(:first-child)");
	var res = base2.querySelectorAll(":scope *[name='stats'] > *:last-child > *:last-child > input[type='number']:not(:first-child)");
	var mod = base2.querySelectorAll(":scope *[name='stats'] > *:last-child > *[name='Mod'] > input[type='number']:not(:first-child)");

	var burnPath = base.querySelector(":scope *[name='Burned'] input");
	var paraPath = base.querySelector(":scope *[name='Paralyzed'] input");

	var sandstormPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='content'] > div[name='field'] *[name='Sandstorm'] input");
	...
	if (pokémon.value != "") {
		...
		for (var i = 0; i < res.length; i++) {
			...
			if (lvl != "") {
				...
				if (stat == "HP") {
					var hpPath = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > div > span[name='"+team+"'] > div[name='"+id+"'] *[name='hp']")
...
function DMGSetInfo() {
	...
	var def = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] > div");
	var user = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > div > span[name] > div[data-string].user");
	var userid = user.getAttribute("name");
	var userteam = user.parentElement.getAttribute("name");
	var userbase = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] > div span[name='"+userteam+"'] ul[name='"+userid+"']");
	var userAbilityPath = userbase.querySelector(":scope *[name='ability'] select");
	...
	var battlesel = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='options'] > div:first-child > span:first-child > select");
	var lis = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='menu'] > div[name='spec'] > span:last-child > li");
	for (var l = 0; l < lis.length; l++) {
		if (parseInt(movePower) > 0) {
			if (lis[l].getAttribute("name") == "Semi-Invulnerable Flight") {
				...
				if (parseInt(battlesel.getAttribute("teammax"))+parseInt(battlesel.getAttribute("opponentmax")) > 2) {
					lis[l].style.removeProperty("display");
				}
			}
...
function DMGSetChange(base) {
	...
	var tar = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > div > span[name='"+team+"'] > div[name='"+id+"']")
	...
	var statsPath = base2.querySelector(":scope *[name='stats']");
	...
	if (check) {
		...
		base2.classList.add("active");
		tar.classList.add("active");


		var pokName = getPokémonName(int);
		...
		if (Natures.length > 0) {
			statsPath.querySelector(":scope > span > span:last-child").removeAttribute("name");
			if (nature != undefined) {
				naturePath.value = nature;
				statsPath.querySelector(":scope > span > span:last-child").setAttribute("name",naturePath.value);
			}
		}
		if (level != undefined) {
	...
	var uls = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] > div ul");
	for (var q = 0; q < uls.length; q++) {
		var mov = uls[q].querySelectorAll(":scope *[name='move'] select");
		uniqueValueSelect(mov);
	}

	tar.lastChild.title = dataStringTitle(tar.getAttribute("data-string"));;
...
function DMGSetPossible() {
	...
	var set = false;
	var tars = [];
	var base = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > div");

	var allbase = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] > div ol ul[name]");

	var old = base.querySelectorAll(":scope > *[name] > *[name]");
	...
	var usertemp = base.querySelectorAll(":scope > *[name='team 1'] > *[name]");
...
function DMGClearData(base) {
	...
	var team = base.parentElement.getAttribute("name");
	var id = base.getAttribute("name");
	var target = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > div > span[name='"+team+"'] > div[name='"+id+"']");
	var base2 = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='options'] > div:last-child > span[name='"+team+"'] > ul[name='"+id+"']")
	...
	if (target != undefined) {
		...
		var ivsPath = base2.querySelectorAll(":scope *[name='stats'] *[name='IV'] input:not(:first-child)");
		var evsPath = base2.querySelectorAll(":scope *[name='stats'] *[name='EV'] input:not(:first-child)");
		var avsPath = base2.querySelectorAll(":scope *[name='stats'] *[name='AV'] input:not(:first-child)");
		var totalPath = base2.querySelectorAll(":scope *[name='stats'] > * > *:last-child input:not(:first-child)");
		...
		for(var e = 0; e < typesPath.length; e++) {
			...
			typesPath[e].value = typesPath[e].firstChild.value;
		}
		...
		target.setAttribute("data-string","");
		base.classList.remove("active")
	}
...
function DMGSaveData(base) {
	...
	var base2 = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='options'] > div:last-child > span[name='"+team+"'] > ul[name='"+id+"']")
	var target = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > div > span[name='"+team+"'] > div[name='"+id+"']");
	var target2 = target.querySelector(":scope > *:last-child")
	...
	if (target != undefined) {
		...
		if (abilityPath.value != undefined && abilityPath.value != "") {
		...
		if (genderPath.value != undefined && genderPath.value != "") {
		...
		if (friendshipPath.value != undefined && friendshipPath.value != "" && friendshipPath.value != 0) {
			stringObj["fr"] = friendshipPath.value;
		}
		else {
			stringObj["fr"] = "";
		}
		if (naturePath.value != undefined && naturePath.value != "") {
		...
		target2.title = dataStringTitle(target.getAttribute("data-string"));
		target.setAttribute("data-string",tempArr.join("|"))
	}
	var tars = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > div > span > div[data-string]");
	var tarsint = 0;
...
function DMGMatchPosition() {
	var teams = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > div > span[name]");
	var poks = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > div > span[name] > div[data-string]");
	...
	var datas4 = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='options'] > div:last-child > span[name] > ul[name]");
	var datas5 = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='options'] > div:last-child > span[name]");
	var datas6 = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > span > span[name]");
	...
	for(var o = 0; o < order1.length; o++) {
		...
		for(var p = 0; p < datas5.length; p++) {
			if (datas5[p].getAttribute("name") == order1[o]) {
				datas5[p].parentElement.appendChild(datas5[p]);
			}
		}
		for(var p = 0; p < datas6.length; p++) {
			if (datas6[p].getAttribute("name") == order1[o]) {
				datas6[p].parentElement.appendChild(datas6[p]);
			}
		}
	...
	for(var o = 0; o < order2.length; o++) {
		...
		for(var p = 0; p < datas4.length; p++) {
			if (datas4[p].parentElement.getAttribute("name")+"-"+datas4[p].getAttribute("name") == order2[o]) {
				datas4[p].parentElement.appendChild(datas4[p]);
			}
		}
	}
...
function DMGSpeedCalc() {
	var ulbases = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='options'] > div:last-child > span[name] > ul[name]");
	var divbases = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > div > span[name] > div[data-string]");
	
	var tr = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='content'] > div[name='field'] li[name='Trick Room'] input")

	if (ulbases.length == divbases.length) {
		var eles = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > div > span[name] > div[data-string] *[name='speed'] > *");
		...
		var speed = [];
		for (var s = 0; s < ulbases.length; s++) {
			var ele = ulbases[s].querySelector(":scope *[name='stats'] > span > span:last-child > *[name='Speed']");
			var obj = new Object();
			obj["Speed"] = ele.value;
			obj["Int"] = s;
			speed.push(obj)
					...
					if (data[d].includes("pok:")) {
						...
						if (tempstr != undefined) {
							if (finaldataPokémon[parseInt(tempstr)][JSONPath_Reference] == "true") {
								...
								ulbase.querySelector(":scope li[name='pokémon'] select").value = dataStringToObj(data[d])["pok"];
			...
			if (data.includes("pok:") && !data.includes("_")) {
				...
				if (tempstr != undefined) {
					if (finaldataPokémon[parseInt(tempstr)][JSONPath_Reference] == "true") {
						...
						ulbase.querySelector(":scope li[name='pokémon'] select").value = dataStringToObj(data)["pok"];
...
function DMGBoxCreate(base,data) {
	if (data == undefined) {
...
function DMGBoxActiveSet() {
	let els1 = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > div > span > div[data-string]");
	let els2 = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > span > span[name] li[data-string]");
...
function buildDMG(preval) {
	...
	let origin = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg']");
	let sel = origin.querySelector(":scope div[name='options'] > div:first-child > span:first-child > select");
	// Save Previous
	let teamds = [];
	let boxds = [];

	var teamdspath = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > div > span[name] > div[data-string]");
	var boxdspath = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > span > span[name] li[data-string]");
	...
	var battleVar = battleVariation[sel.getAttribute("name")];
	let teamsMax = parseInt(battleVar["Teams"]);
	...
	if (deleted) {
		...
		if (!ask) {
			...
			if (val != undefined && !isNaN(val)) {
				let el = toolSectionContentDMGOptionsBattlesSelect.querySelector(":scope option[name='"+val+"']");
				let keys = el.getAttributeNames();
				for(var q = 0; q < keys.length; q++) {
					let val1 = keys[q];
					let val2 = el.getAttribute(keys[q]);
					toolSectionContentDMGOptionsBattlesSelect.setAttribute(val1,val2);
				}
				toolSectionContentDMGOptionsBattlesSelect.value = el.value;
				return;
			}
	...
	let toolSectionContentDMGOptionsContentTop = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] > div ol[name='pokémon']");
	let toolSectionContentDMGOptionsContentBottom = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] > div ol[name='team']");
	let toolSectionContentDMGOptionsStats = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='options'] > div:last-child");
	let toolSectionContentDMGOptionsTitle = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='options'] > div:first-child > span:last-child");
	let toolSectionContentDMGAll = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='content'] > div[name='field']");
	let toolSectionContentDMGResultContent = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > div");
	let toolSectionContentDMGResultBox = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > span");
	let toolSectionContentDMGMenuSpecificBottom = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='menu'] > div[name='spec'] > span:last-child");

	let toolSectionContentDMGResult = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result']");


	toolSectionContentDMGOptionsContentTop.innerHTML = "";
	toolSectionContentDMGOptionsContentBottom.innerHTML = "";
	toolSectionContentDMGOptionsStats.innerHTML = "";
	toolSectionContentDMGOptionsTitle.innerHTML = "";
	toolSectionContentDMGAll.innerHTML = "";
	toolSectionContentDMGResultContent.innerHTML = "";
	toolSectionContentDMGResultBox.innerHTML = "";
	...
	for(var q = 0; q < battleVar["Teams"]; q++) {
		...
		toolSectionContentDMGOptionsTitleTeam.addEventListener("change",function(){var x = this.value; var z = this.getAttribute("name");var dvs = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] > div span[name='"+z.toLowerCase()+"'] ul"); var dv = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] > div span[name='"+z.toLowerCase()+"'] ul:nth-child("+(parseInt(x)+1)+")");for (var i = 0; i < dvs.length; i++) {dvs[i].style.display = "none";} for (var i = 0; i < dv.length; i++) {dv[i].style.display="flex"};})
	

		var resultTeams = document.createElement("span");
		resultTeams.setAttribute("name",teamName.toLowerCase());
		toolSectionContentDMGResultContent.appendChild(resultTeams);

		var boxTeam = document.createElement("span");
		boxTeam.setAttribute("name",teamName.toLowerCase());
		toolSectionContentDMGResultBox.appendChild(boxTeam);

		var boxTeamOpen = document.createElement("figure");
		var boxTeamOpenText = document.createElement("h5");
		boxTeamOpen.setAttribute("type","invert");
		boxTeamOpenText.innerText = "⮝";
		boxTeamOpen.classList.add("open");
		boxTeam.appendChild(boxTeamOpen);
		boxTeamOpen.appendChild(boxTeamOpenText);

		boxTeamOpen.addEventListener("click",function(){if(this.parentElement.classList.contains("active")) {this.parentElement.classList.remove("active")} else {this.parentElement.classList.add("active");}});


		
		var boxTeamWrap = document.createElement("span");
		boxTeam.appendChild(boxTeamWrap);
		var boxTeamInner = document.createElement("span");
		boxTeamWrap.appendChild(boxTeamInner)


		var boxTeamDel = document.createElement("figure");
		var boxTeamDelText = document.createElement("h6");
		boxTeamDel.classList.add("del");
		boxTeamDel.setAttribute("type","scale");
		boxTeamDelText.innerText = "❌";
		boxTeamInner.appendChild(boxTeamDel);
		boxTeamDel.appendChild(boxTeamDelText);
		boxTeamDel.addEventListener("click",function(){
			var ask = confirm("The Pokémon's data will not be saved.\nDo you want to continue?");
			if (ask) {
		...
		var boxTeamAdd = document.createElement("li");
		var boxTeamAddText = document.createElement("h2");
		boxTeamAdd.classList.add("add");
		boxTeamAddText.innerText = "+";
		boxTeamInner.appendChild(boxTeamAdd);
		boxTeamAdd.appendChild(boxTeamAddText);
		boxTeamAdd.addEventListener("click",function(){DMGBoxCreate(this.parentElement.parentElement.parentElement)});
		...
		for(var r = 0; r < teamCount; r++) {
			...
			var resultTeamActiveSpeed = document.createElement("span");
			var resultTeamActiveSpeedText = document.createElement("h6");
			var resultTeamActiveBar = document.createElement("span");
			var resultTeamActiveBarSTAB = document.createElement("small");
			var resultTeamActiveBarEffect = document.createElement("small");
			...
			resultTeamInactive.setAttribute("name","inactive");
			resultTeamActive.setAttribute("name","active");
			...
			resultTeamActiveSpeed.setAttribute("name","speed");

			resultTeamActiveBar.setAttribute("name","bar");
			resultTeamActiveBarSTAB.setAttribute("name","stab");
			resultTeamActiveBarEffect.setAttribute("name","effect");


			resultTeam.appendChild(resultTeamActiveBar);
			resultTeamActiveBar.appendChild(resultTeamActiveBarSTAB);
			resultTeamActiveBar.appendChild(resultTeamActiveBarEffect);
			...
			resultTeamActiveTop.appendChild(resultTeamActiveSpeed);
			resultTeamActiveSpeed.appendChild(resultTeamActiveSpeedText);
		...
		if (teamCount > 1) {
			let els = resultTeams.querySelectorAll(":scope *[name='bar']");
			for(var d = 0; d < els.length; d++) {
				els[d].classList.add("on");
			}
		...
		var resultTeamsOverlay = document.createElement("span");
		var resultTeamsOverlayText = document.createElement("p");
		resultTeamsOverlayText.innerText = "⋮⋮⋮";
		resultTeams.appendChild(resultTeamsOverlay)
		resultTeamsOverlay.appendChild(resultTeamsOverlayText);
	...
	for(var d = 0; d < divsTop.length; d++) {
		...
		for(var e = 0; e < poks.length; e++) {
			...
			if (getPokémonInt(poks[e]) != undefined) {
				pokOption.setAttribute("data-variant",finaldataPokémon[getPokémonInt(poks[e])]["Variant"]);
			}
		...
		if (pokSelect.querySelectorAll(":scope option[data-variant]:not([data-variant*='Default']").length > 0) {
			...
			var pokFormLabelText = document.createElement("h6");
			...
			pokFormInput.addEventListener("change",function(){var tars = findUpTag(this,"LI").querySelectorAll(":scope select option"); var tar = findUpTag(this,"LI").querySelectorAll(':scope select option[data-variant]:not([data-variant*="Default"])');for(var t = 0; t < tars.length; t++) {tars[t].style.removeProperty("display");tars[t].removeAttribute("disabled");} if(!this.checked){ for(var t = 0; t < tar.length; t++) {tar[t].style.display = "none";tar[t].setAttribute("disabled","");}}})
		}
		...
		$(moveWrap).sortable({
			update: function(e,ui) {		
				...
				for (var q = 0; q < eles.length; q++) {
					eles[q].setAttribute("name",q)
					eles[q].firstChild.setAttribute("value","Move #"+(q+1));
					eles[q].firstChild.innerText = "Move #"+(q+1);
				}
		...
		for(var c = 0; c < conditions.length; c++) {
			...
			if (check) {
				...
				if (conditions[c]["Affect"] == "Team") {
					if (d == 0) {
						appender = toolSectionContentDMGOptionsContentBottom.querySelector(":scope > *[name='team 1']");
					}
					else if (d > 0 && divsBottom.length == 2) {
						appender = toolSectionContentDMGOptionsContentBottom.querySelector(":scope > *[name='team 2']")
					}
					else {
						appender = toolSectionContentDMGOptionsContentBottom.querySelector(":scope > *[name='team "+(d+1)+"']");
					}
		...
		headerText.innerText = titleCase(base.parentElement.getAttribute("name"));
		...
		reset.addEventListener("click",function(){var base = findUpTag(this,"UL");DMGRemoveDataString(document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > div > span[name='"+base.parentElement.getAttribute("name")+"'] > div[name='"+base.getAttribute("name")+"']"))})
		...
		function exChange() {
			...
			var divbase = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > div > span[name='"+team+"'] > div[data-string][name='"+id+"']")
	...
	var teams = battleVar["Teams"];
	teams = parseInt(teams);
	
	for(var q = 0; q < teams; q++) {
		var x = q+1;
		var statsteam = document.createElement("span");
		statsteam.setAttribute("name","team "+x)
		toolSectionContentDMGOptionsStats.appendChild(statsteam);
		...
		var poks = battleVar[column];
		poks = parseInt(poks)

		for(var d = 0; d < poks; d++) {
			var statspok = document.createElement("ul");
			statspok.setAttribute("name",d)
			statsteam.appendChild(statspok)
			...
			for(var e = 0; e < inprange; e++) {
				...
				for(var s = 0; s < statsTemp.length; s++) {
					...
					statsWrapInput.addEventListener("input",function(){var x = findUpTag(this,"UL");var base2 = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='options'] ol[name='pokémon'] > span[name='"+x.parentElement.getAttribute("name")+"'] > ul[name='"+x.getAttribute("name")+"']");DMGCalcPokStats(base2)});
					statsWrapInput.addEventListener("input",function(){var x = findUpTag(this,"UL");var base2 = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='options'] ol[name='pokémon'] > span[name='"+x.parentElement.getAttribute("name")+"'] > ul[name='"+x.getAttribute("name")+"']");DMGSaveData(base2)});
					statsWrapInput.addEventListener("input",function(){var x = findUpTag(this,"UL");var base2 = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='options'] ol[name='pokémon'] > span[name='"+x.parentElement.getAttribute("name")+"'] > ul[name='"+x.getAttribute("name")+"']");DMGCalcStart(base2)});
	...
	for(var c = 0; c < conditions.length; c++) {
		...
		if (check) {
			...
			var appender = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='content'] > div[name='field']")
			var check = true;
			...
			if (check) {
				if (conditions[c]["Group"] != undefined) {
					...
					if (conditions[c]["Name"] == "Trick Room") {
						conditionInput.addEventListener("change",function(){var x = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] > div span[name] ul[name]"); for (var r = 0; r < x.length; r++) {DMGCalcPokStats(x[r]);}})
					}
	...
	if (Generation == 1 || Generation == 2) {
		...
		var halfway = ((randomPath.value-parseInt(randomPath.getAttribute("min")))/(parseInt(randomPath.getAttribute("max"))-parseInt(randomPath.getAttribute("min"))))*100;
	...
	if (toolSectionContentDMGAll.firstChild != undefined) {
		toolSectionContentDMGAll.style.removeProperty("display");
		toolSectionContentDMGResult.style.removeProperty("height");
	}
	else {
		toolSectionContentDMGAll.style.display = "none";
		toolSectionContentDMGResult.style.height = "80%";
	}
	...
	for(var q = 0; q < teamds.length; q++) {
		...
		let els = document.querySelectorAll("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > div > span[name='"+team+"'] > div[data-string]");
	...
	for(var q = 0; q < boxds.length; q++) {
		...
		let el = document.querySelector("#contain div#tool > section[name='content'] > div[name='dmg'] div[name='result'] > span > span[name='"+team+"']")
		if (el != undefined) {
			DMGBoxCreate(el,data)
		}
	}
